...
SECRET_KEY = 'django-insecure-l!tk8x@b5lvmw8%+t11=i5ecry4=zd-!0)m(wzqg#n0w4+tyuz'
...
DATABASE_URL = {'default': dj_database_url.config(default=os.environ.get('DATABASE_URL'))}
# Password validation
